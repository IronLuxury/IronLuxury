module.exports.reserveTemplate = (email) => {
    return `
    ...
    @media only screen and (max-width:480px) {
      ...
      <img alt="header image" height="auto" src="https://images.unsplash.com/photo-1494697536454-6f39e2cc972d?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=2251&q=80" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600">
      ...
      <div style="font-family:Arial, sans-serif;font-size:22px;font-weight:bold;line-height:30px;text-align:center;color:#489BDA;">Click on the following button to cancel your reservation<br>
          </div>
